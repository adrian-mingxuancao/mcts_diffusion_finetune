#!/usr/bin/env python3
"""
FlowFlow model integration for motif scaffolding via denovo-protein-server
"""
...
class FlowFlowExpertModel:
    ...
    def __init__(self, server_url: str = "http://localhost:8081"):
        ...
        print(f"✅ {self.name} expert initialized (denovo-protein-server API)")
    ...
    def generate_scaffold(self, motif_data, scaffold_length: int, **kwargs) -> Optional[Dict]:
        ...
        try:
            ...
            # FlowFlow generates protein backbones and sequences
            request_data = {
    ...
    def _fallback_generation(self, motif_data, scaffold_length: int) -> Dict:
        ...
        # Generate FlowFlow-biased scaffold (more diverse sequences)
